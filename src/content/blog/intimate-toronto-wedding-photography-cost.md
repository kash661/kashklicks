...
faq:
  - question: "How much does a wedding photographer cost in Toronto?"
    answer: "In 2026, realistic professional rates in the GTA look roughly like this. A short City Hall or civil ceremony of one to two hours runs about $450 to $1,200. An intimate half-day wedding of four to six hours runs about $1,200 to $3,000. A full day of eight to ten hours runs about $2,800 to $5,500 for most established professionals, with premium names going higher. Anything under $2,000 usually means short coverage or a newer photographer."
  - question: "Why do some wedding photographers cost so much more than others?"
    answer: "Price reflects time, experience, and what you actually get. The biggest drivers are hours of coverage, whether a second shooter is added, albums and prints, an engagement session, and the photographer's demand and track record. Two photographers quoting very different numbers are often selling very different things, so always compare what is included, not just the headline price."
  - question: "How much is a City Hall or civil ceremony photographer?"
    answer: "For a short one to two hour civil ceremony with portraits afterward, most GTA professionals charge between $450 and $1,200. Some high-end wedding photographers do not offer short coverage at all. Our own Civil Ceremony coverage is a fixed package that covers the ceremony and the portraits right after."
  - question: "Do you need a second shooter?"
    answer: "Not always. A second shooter helps for large guest counts, multiple simultaneous events, or when you want both partners' preparations covered at once. For intimate weddings, City Hall ceremonies, and backyard weddings, one experienced photographer is usually plenty, and it keeps the day calm and the cost down. We shoot solo by design, so the eye behind the camera is consistent all day."
  ...
  - question: "What does AD Photography charge?"
    answer: "Our pricing is public. The Civil Ceremony package is $501.25, The Elopement (4 hours, ceremony through the reception after) is $901.25, wedding day coverage starts at $1,401.25 (The Essentials, 6 hours), The Full Day is $2,501.25, and The Complete Story is $3,801.25 for up to 14 hours with a second photographer. Pre-wedding sessions start at $351.25. Every package includes the edited high-resolution gallery."
---
